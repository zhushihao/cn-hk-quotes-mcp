...
用户正文要先讲清楚“AI 融资现在是更松还是更紧、长端利率有没有同步变化、两者有没有足够证据连起来”，再展示专业因果判断。不得把单次美债涨跌直接归因于 AI。
...
**一句话结论**
- 1–2 句直接说明：AI 基建融资条件是改善、恶化还是分化；“AI 融资挤出效应”核心假设的置信度是上升、下降还是不变。

**发生了什么**
- 只写 1–3 个本轮新增事实：发行规模、期限、利差、认购、项目融资结构、银行风险转移或其他真实融资变化。

**为什么重要**
- 用人话解释这意味着“钱更难拿 / 更贵 / 只有高信用项目拿得到 / 长钱供给压力变大”等哪一种机制变化。

**美债这边发生了什么**
- 简明写 2Y / 10Y / 30Y 与期限结构的相关变化；只写与本轮判断有关的部分，不堆行情。

**对核心假设的影响**
- **AI 融资挤出效应：置信度上升 / 下降 / 不变。**
- 用 1–2 句说明时间与机制是否匹配，以及为什么不能由替代解释单独解释。

**还有哪些更可能的解释**
- 最多列 1–3 个：通胀、Fed 路径、财政赤字/国债净供给、期限溢价、海外需求、风险偏好、美元流动性等；说明它们当前能解释多少。

**对组合的影响**
- 仅在确有必要时写本轮 `live_universe` 的相关 ACTIVE 标的，并强调融资变化影响的是项目兑现节奏/资本成本，不自动等于个股买卖信号。

**接下来只盯什么**
- 只列 1–3 个能改变因果判断的具体指标，例如新增长期发行、利差、认购倍数、SRT 扩散、项目实际通电/再融资结果。

表达要求：事实、投资推断、替代解释、尚缺证据必须分开；数字保留期限和口径，少用债券术语堆砌。
